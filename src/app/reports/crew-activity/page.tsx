...
export default function CrewActivityReportPage() {
    ...
    const reportTitle = `${currentUser.company} Crew Activity Report`;
    const reportDescription = "A summary of all crew dockets from your company, showing key productivity metrics.";

...
export default function MyCompanyTimesheetsPage() {
    ...
    if (timesheets.length === 0) {
        return (
            <div className="container mx-auto max-w-6xl py-8 px-4 md:px-6">
                <Card className="shadow-lg">
                    <CardHeader>
                        <CardTitle className="font-headline text-3xl">All {currentUser.company} Timesheets</CardTitle>
                        <CardDescription>A log of all individual timesheets from your company.</CardDescription>
                    </CardHeader>
                    <CardContent>
